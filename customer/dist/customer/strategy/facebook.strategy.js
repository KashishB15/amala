...
let FacebookStrategy = class FacebookStrategy extends (0, passport_1.PassportStrategy)(passport_facebook_1.Strategy, "facebook") {
    constructor(customerService) {
        super({
            clientID: constants_1.constants.FACEBOOK_CLIENT_ID,
            clientSecret: constants_1.constants.FACEBOOK_SECRET_KEY,
            callbackURL: constants_1.constants.FACEBOOK_CALLBACK_URL,
            scope: "email",
